...
//        );
//        this.iArrVertices[index].texture = new XYZTextureUV(0,0, textureID);
//        index++;
//
//        //2. low left
//        this.iArrVertices[index] = new XYZVertex(
...
//        this.iArrVertices[index].texture = new XYZTextureUV(0,1, textureID);
//        index++;
//        //3. right bottom
//        this.iArrVertices[index] = new XYZVertex(
//                new XYZCoordinate(this.iArrVertices[rightBottom].coordinate.asArray())
//        );
//        this.iArrVertices[index].texture = new XYZTextureUV(1,0, textureID);
//        index++;
//
//        //4. low right
//        this.iArrVertices[index] = new XYZVertex(
...
//        this.iArrVertices[index].coordinate.setZ(
//                this.iArrVertices[index].coordinate.z() + deltaTrapeze);
//        this.iArrVertices[index].texture = new XYZTextureUV(1,1, textureID);
//        index++;
//
//
