...
//        final XYZTextureUV squareTexture = upperLeftCoordinate.texture;
//
...
//        coordinatesArray[1].texture = new XYZTextureUV(0,1,
...
//        coordinatesArray[2].texture = new XYZTextureUV(1,0,
//                squareTexture.textureID());
//
...
//        coordinatesArray[3].texture = new XYZTextureUV(1,1,
//                squareTexture.textureID());
//
